...
import 'package:edupro_admin/models/lesson.dart';
import 'package:edupro_admin/widgets/dropdown_widget.dart';
import 'package:edupro_admin/widgets/textfield_widget.dart';
import 'package:edupro_admin/widgets/video_picker.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Visibility(
                  ...
                  child: BeTextField(
                      title: "Ссылка на видео",
                      subtitle: "Напишите сюда ссылку на видео",
                      text: videoIDController.text,
                      callback: (videoID) {
                        videoIDController.text = videoID;
                      }),
                ...
                BeTextField(
                    title: "название",
                    subtitle: "Введите название видео",
                    text: videoTitleController.text,
                    callback: (videoTitle) {
                      videoTitleController.text = videoTitle;
                    }),
                ...
                BeTextField(
                    title: "Продолжительность видео",
                    subtitle: "Введите продолжительность",
                    text: durationController.text,
                    callback: (videoTitle) {
                      durationController.text = videoTitle;
                    }),
