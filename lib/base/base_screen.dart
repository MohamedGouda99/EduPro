...
import 'package:edupro_admin/screens/categories_screen.dart';
import 'package:edupro_admin/screens/courses_screen.dart';
import 'package:edupro_admin/screens/news_screen.dart';
import 'package:edupro_admin/screens/onboarding_screen.dart';
      ...
      child: Padding(
        ...
        child: Text(
          ...
          style: GoogleFonts.teko(
              fontSize: 17, fontStyle: FontStyle.normal, color: Colors.grey),
        ),
      ),
    );
  }
      ...
      child: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              addRow(Icons.dashboard, "Панель приборов", SCREEN.home),
              addRow(Icons.school, "Университеты", SCREEN.courses),
              ...
              addRow(Icons.chat, "Тех поддержка", SCREEN.chat),
              // addRow(Icons.cast_for_education, "Manager chat", SCREEN.chat),
