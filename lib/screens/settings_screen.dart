...
import 'package:edupro_admin/models/ra_settings.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget mainArea() {
    return Column(
      ...
      children: [
        ...
        sectionTitle("Цвета темы"),
        themeOptions(),
        SizedBox(
          height: spaceBetweenItems,
        ),
        sectionTitle("Социальное сети"),
        socialArea(),
        SizedBox(
          height: spaceBetweenItems,
        ),
  ...
  Widget aboutUsArea() {
    return BeTextView(
        title: "О нас (теги HTML разрешены)",
        subtitle: "Введите здесь текст",
  ...
  Widget maintenanceMode() {
    return Row(
      ...
      children: [
        BeToggle(
            name: "Включить режим тех поддержки",
        ...
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                showAlertDialog(context, "Мгновенные обновления",
                ...
                SizedBox(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelText: 'Введите здесь имя приложения',
                    ),
                  ),
                ),
              ],
                ...
                SizedBox(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelText:
                          'Введите здесь адрес электронной почты службы поддержки',
                    ),
                  ),
                ),
              ],
      ...
      children: [
        ...
        Visibility(
            ...
            child: Row(
              ...
              children: [
                BeToggle(
                    name: "Включить вход через Facebook",
                ...
                BeToggle(
                    name: "Включить вход через Google",
                ...
                BeToggle(
                    name: "Включить вход по электронной почте",
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            BeColorPicker(
                name: "Bottom Bar Selected Items Color",
      ...
      children: [
        Row(
          ...
          children: [
            BeTextField(
                title: "Facebook",
                subtitle: "Введите ссылку на фейсбук",
            ...
            BeTextField(
                title: "Instagram",
                subtitle: "Введите ссылку на инстаграм",
        ...
        Row(
          ...
          children: [
            BeTextField(
                title: "Twitter",
                subtitle: "Введите ссылку на твиттер",
            ...
            BeTextField(
                title: "Pinterest",
                subtitle: "Введите ссылку на пинтерест",
        ...
        Row(
          ...
          children: [
            BeTextField(
                title: "LinkedIn",
                subtitle: "Введите связанную ссылку",
            ...
            BeTextField(
                title: "TikTok",
                subtitle: "Введите ссылку на тикток",
        ...
        Row(
          ...
          children: [
            BeTextField(
                title: "YouTube",
                subtitle: "Введите ссылку на видео",
            ...
            BeTextField(
                title: "Vimeo",
                subtitle: "Введите ссылку на ютуб",
      ...
      children: [
        Column(
          ...
          children: [
            ...
            BeToggle(
                name: "Убить приложение при выходе",
        ...
        Column(
          ...
          children: [
            BeToggle(
                name: "Включить альбомную ориентацию",
