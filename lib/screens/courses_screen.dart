...
import 'package:edupro_admin/models/ra_options.dart';
import 'package:edupro_admin/widgets/dropdown_category_widget.dart';
import 'package:edupro_admin/widgets/lessons_picker.dart';
import 'package:edupro_admin/widgets/loading.dart';
...
class _CoursesScreenState extends State<CoursesScreen> {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Проведите налево что бы удалить университет",
                    ...
                    onDismissed: (direction) {
                      if (demoMode) {
                        ScaffoldMessenger.of(context)
                          ...
                          content: Text(
                            "НЕ МОЖЕТ ИЗМЕНИТЬ ДЕМО АДМИНИСТРАТОРА",
                      ...
                      setState(() {
                        ...
                        updateItems("Университет удален");
                      });
                    },
                    child: Padding(
  ...
  Widget mainArea() {
    String title = "Университеты";
    String subtitle = "Добавить категорию";
  ...
  Widget courseOptions() {
    return Column(
      ...
      children: [
        ...
        titleForItem("Название университета", 'Название университета.',
            nameTextController),
        const SizedBox(
          height: 20,
        ),
        ...
        titleForItem("Ректор", 'Teacher name', teacherTextController),
        const SizedBox(
          height: 20,
        ),
        titleForItem("Обучение", "Курс студента", levelTextController),
        const SizedBox(
          height: 20,
        ),
        titleForItem("Описание университета", "HTML-теги разрешены",
            descriptionTextController),
        const SizedBox(
          height: 20,
        ),
        titleForItem("Теги", "Теги через запятую", tagsTextController),
        const SizedBox(
          height: 20,
        ),
        BeImagePicker(
  ...
  addItem() async {
    ...
    Widget continueButton = TextButton(
      ...
      onPressed: () {
        ...
        Navigator.of(context).pop();
        clearAllControllers();
        updateItems("Университет добавлен");
      },
    );
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      titleForItem("Название университета",
                          'Название университета.', nameTextController),
                      const SizedBox(
                        height: 20,
                      ),
                      titleForItem(
                          "Ректор", 'Имя ректора', teacherTextController),
                      const SizedBox(
                        height: 20,
                      ),
                      titleForItem(
                          "С какого курса принимают",
                          "уровень студента - к примеру первый курс",
                          levelTextController),
                      const SizedBox(
                        height: 20,
                      ),
                      titleForItem("Описание университета",
                          "HTML-теги разрешены", descriptionTextController),
                      const SizedBox(
                        height: 20,
                      ),
                      titleForItem(
                          "Теги", "Теги через запятую", tagsTextController),
                      const SizedBox(
                        height: 20,
                      ),
                      BeImagePicker(
  ...
  showEditDialog(BuildContext context, Course item, int index) {
    ...
    Widget continueButton = TextButton(
      ...
      onPressed: () {
        ...
        Navigator.of(context).pop();
        clearAllControllers();
        updateItems("Университет обновлен");
      },
    );
