...
class _NotificationScreenState extends State<NotificationScreen> {
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelText:
                              'Напишите заголовок для нашего уведомления',
                        ),
                      ),
                    ),
                    const SizedBox(
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelText: 'Напишите описание для нашего уведомления',
                        ),
                      ),
                    ),
                    const SizedBox(
  ...
  void updateSettings(RASettings general) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
      content: Text("Настройки push-уведомлений обновлены!"),
    ));
    setState(() {});
  }
    ...
    Widget continueButton = TextButton(
      ...
      onPressed: () async {
        ...
        if (success) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content:
                Text("Большой! Ваше уведомление отправлено на все устройства"),
          ));
        }
      },
    );
