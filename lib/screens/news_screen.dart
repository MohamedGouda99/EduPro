...
import 'package:edupro_admin/models/post.dart';
  ...
  Widget categoryOptions() {
    return Column(
      ...
      children: [
        ...
        titleForItem(
            "Название поста", 'Введите название.', titleTextController),
        const SizedBox(
          height: 20,
        ),
        titleForItem(
            "Содержимое поста", 'Введите содержимое.', textTextController),
        const SizedBox(
          height: 20,
        ),
        BeImagePicker(
          ...
          imageText: "Добавить изображение поста",
        ...
        BeImagePicker(
          ...
          imageText: "Добавить фото автора",
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                titleForItem("Название поста", 'Введите название поста.',
                    titleTextController),
                const SizedBox(
                  height: 20,
                ),
                titleForItem(
                    "Содержимое поста", 'Введите текст.', textTextController),
                const SizedBox(
                  height: 20,
                ),
                BeImagePicker(
                ...
                titleForItem("Имя автора", 'Введите имя автора.',
                    authorNameTextController),
                const SizedBox(
                  height: 20,
                ),
                BeImagePicker(
                  ...
                  imageText: "Добавьте фото автора",
                  preloadedImage: authorImageUrl,
                ),
              ],
            ),
