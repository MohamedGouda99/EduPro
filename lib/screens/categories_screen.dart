...
import 'package:edupro_admin/models/category.dart';
                    ...
                    onDismissed: (direction) {
                      if (demoMode) {
                        ScaffoldMessenger.of(context)
                          ...
                          content: Text(
                            "НЕ МОЖЕТ ИЗМЕНИТЬ ДЕМО-ПРОГРАММУ АДМИНИСТРАТОРА",
  ...
  Widget categoryOptions() {
    return Column(
      ...
      children: [
        ...
        titleForItem(
            "Название категории", 'Введите название.', nameTextController),
        const SizedBox(
          height: 20,
        ),
        BeImagePicker(
  ...
  showEditDialog(BuildContext context, RACategory item, int index) {
    ...
    Widget continueButton = TextButton(
      ...
      onPressed: () {
        ...
        Navigator.of(context).pop();
        clearAllControllers();
        updateItems("Категорию обнавлена");
      },
    );
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  titleForItem("Название категории", 'Введите название.',
                      nameTextController),
                  const SizedBox(
                    height: 20,
                  ),
